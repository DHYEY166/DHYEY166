...
- **Breast Cancer Semantic Segmentation:** I'm working on a project to develop deep learning models for precise tumor segmentation in breast cancer images. This has the potential to significantly aid in early diagnosis and treatment planning. ([PROJECT LINK](https://github.com/DHYEY166/BREAST_CANCER_SEMANTIC_SEGMENTATION))
...
- **Collaborating on Hate Speech Detection:** I'm passionate about using AI for social good. I'm looking to collaborate on projects that leverage NLP to detect and combat hate speech and offensive language online.  ([PROJECT LINK](https://github.com/DHYEY166/Hate-Speech-and-Offensive-Language-Detection))

## 📄 Resume & Contact

- 💼 View my resume: [DHYEY DESAI RESUME](https://drive.google.com/drive/folders/1HWRSyTlnmr6K0YvGM_2ryYaFB3tAvkN0?usp=share_link)
